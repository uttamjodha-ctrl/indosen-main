...
`;const l={root:null,rootMargin:"0px",threshold:.1},d=new IntersectionObserver((s,i)=>{s.forEach(t=>{t.isIntersecting&&(t.target.classList.add("visible"),i.unobserve(t.target))})},l);document.querySelectorAll(".fade-in").forEach(s=>{d.observe(s)});const n=document.querySelector(".mobile-menu-btn"),c=document.querySelector(".nav");n.addEventListener("click",()=>{c.classList.toggle("active"),n.classList.toggle("active")});document.querySelectorAll('a[href^="#"]').forEach(s=>{s.addEventListener("click",function(i){i.preventDefault(),c.classList.remove("active"),n.classList.remove("active"),document.querySelector(this.getAttribute("href")).scrollIntoView({behavior:"smooth"})})});
